...
import { Users, GraduationCap, BookOpen, Target, Award, Lightbulb } from "lucide-react";
    ...
    >
      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-40 left-10 w-64 h-64 rounded-full bg-enactus-blue/5 blur-3xl" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              The Story of <span className="text-enactus-blue">Enactus EMI</span>
            </motion.h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -top-8 -left-8 w-48 h-48 md:w-64 md:h-64 rounded-full bg-enactus-blue/10 -z-10" />
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="inline-block px-3 py-1 bg-enactus-blue/10 text-enactus-blue rounded-full text-sm font-medium">
                Our Story
              </div>
              ...
              <div className="pt-4 grid grid-cols-2 gap-4">
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-enactus-blue/10 text-enactus-blue">
                    <Target size={20} />
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-enactus-yellow/20 text-gray-700">
                    <Award size={20} />
                  </div>
                  <div>
                    <h3 className="font-semibold">8+</h3>
                    <p className="text-sm text-gray-500">Global Recognitions</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="w-12 h-12 flex items-center justify-center rounded-full bg-enactus-blue/10 text-enactus-blue mb-4">
                  <value.icon size={20} />
                </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex space-x-4">
                    <a
                      href="#"
                      className="text-gray-400 hover:text-enactus-blue transition-colors duration-300"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="pt-4 space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 flex items-center justify-center rounded-full bg-enactus-blue text-white mt-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="20 6 9 17 4 12"></polyline>
                    </svg>
                  </div>
                  <p className="text-gray-700">Develop leadership and teamwork skills</p>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Work on real-world projects with measurable impact</p>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Connect with a global network of students and professionals</p>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Represent EMI at national and international competitions</p>
                </div>
              </div>
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -top-8 -right-8 w-48 h-48 md:w-64 md:h-64 rounded-full bg-enactus-blue/10 -z-10" />
              </div>
            </motion.div>
          </div>
        </div>
